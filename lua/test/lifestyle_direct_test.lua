...
describe("LifestyleDirect", function()
  it("should direct-load-lifestyle", function()
    local setup = lifestyle_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-lifestyle", setup.live and "live" or "unit")
...
function lifestyle_direct_setup(mockres)
