...
describe("EquipmentSetDirect", function()
  it("should direct-list-equipment_set", function()
    local setup = equipment_set_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-equipment_set", setup.live and "live" or "unit")
  ...
  it("should direct-load-equipment_set", function()
    local setup = equipment_set_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-equipment_set", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function equipment_set_direct_setup(mockres)
