...
describe("CoupleDirect", function()
  it("should direct-load-couple", function()
    local setup = couple_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-couple", setup.live and "live" or "unit")
...
function couple_direct_setup(mockres)
