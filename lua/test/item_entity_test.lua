...
describe("ItemEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FLYFFGAME_TEST_ITEM_ENTID JSON to run live")
      return
    end
...
function item_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FLYFFGAME_TEST_ITEM_ENTID")
