...
describe("RaisedPetDirect", function()
  it("should direct-load-raised_pet", function()
    local setup = raised_pet_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-raised_pet", setup.live and "live" or "unit")
...
function raised_pet_direct_setup(mockres)
