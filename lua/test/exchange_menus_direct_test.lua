...
describe("ExchangeMenusDirect", function()
  it("should direct-load-exchange_menus", function()
    local setup = exchange_menus_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-exchange_menus", setup.live and "live" or "unit")
...
function exchange_menus_direct_setup(mockres)
