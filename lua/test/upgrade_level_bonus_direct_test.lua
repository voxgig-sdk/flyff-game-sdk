...
describe("UpgradeLevelBonusDirect", function()
  it("should direct-load-upgrade_level_bonus", function()
    local setup = upgrade_level_bonus_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-upgrade_level_bonus", setup.live and "live" or "unit")
...
function upgrade_level_bonus_direct_setup(mockres)
