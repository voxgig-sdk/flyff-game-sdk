...
describe("AwakeDirect", function()
  it("should direct-load-awake", function()
    local setup = awake_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-awake", setup.live and "live" or "unit")
...
function awake_direct_setup(mockres)
