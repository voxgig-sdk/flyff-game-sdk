...
describe("BadgeDirect", function()
  it("should direct-load-badge", function()
    local setup = badge_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-badge", setup.live and "live" or "unit")
...
function badge_direct_setup(mockres)
