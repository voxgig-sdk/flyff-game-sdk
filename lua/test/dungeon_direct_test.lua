...
describe("DungeonDirect", function()
  it("should direct-load-dungeon", function()
    local setup = dungeon_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dungeon", setup.live and "live" or "unit")
...
function dungeon_direct_setup(mockres)
