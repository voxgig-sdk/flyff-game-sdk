...
describe("ElementDirect", function()
  it("should direct-load-element", function()
    local setup = element_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-element", setup.live and "live" or "unit")
...
function element_direct_setup(mockres)
