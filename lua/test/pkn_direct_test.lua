...
describe("PknDirect", function()
  it("should direct-load-pkn", function()
    local setup = pkn_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-pkn", setup.live and "live" or "unit")
...
function pkn_direct_setup(mockres)
