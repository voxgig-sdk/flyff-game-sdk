...
local RaisedPetEntity = {}
RaisedPetEntity.__index = RaisedPetEntity


function RaisedPetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RaisedPetEntity)
  self._name = "raised_pet"
  self._client = client
...
function RaisedPetEntity:get_name()
  return self._name
end


function RaisedPetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RaisedPetEntity.new(self._client, opts)
end
...
function RaisedPetEntity:mark_deleted()
  self._deleted = true
end


function RaisedPetEntity:deleted()
  return true == self._deleted
end


function RaisedPetEntity:data_set(args)
  if args ~= nil then
...
function RaisedPetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RaisedPetEntity:match_set(args)
  if args ~= nil then
...
function RaisedPetEntity:match_get()
...
function RaisedPetEntity:stream(action, args, callopts)
...
function RaisedPetEntity:_run_op(ctx, post_done)
  local utility = self._utility
