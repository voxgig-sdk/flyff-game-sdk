...
local UpgradeLevelBonusEntity = {}
UpgradeLevelBonusEntity.__index = UpgradeLevelBonusEntity


function UpgradeLevelBonusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UpgradeLevelBonusEntity)
  self._name = "upgrade_level_bonus"
  self._client = client
...
function UpgradeLevelBonusEntity:get_name()
  return self._name
end


function UpgradeLevelBonusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UpgradeLevelBonusEntity.new(self._client, opts)
end
...
function UpgradeLevelBonusEntity:mark_deleted()
  self._deleted = true
end


function UpgradeLevelBonusEntity:deleted()
  return true == self._deleted
end


function UpgradeLevelBonusEntity:data_set(args)
  if args ~= nil then
...
function UpgradeLevelBonusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UpgradeLevelBonusEntity:match_set(args)
  if args ~= nil then
...
function UpgradeLevelBonusEntity:match_get()
...
function UpgradeLevelBonusEntity:stream(action, args, callopts)
...
function UpgradeLevelBonusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UpgradeLevelBonusEntity
