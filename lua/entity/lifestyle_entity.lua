...
local LifestyleEntity = {}
LifestyleEntity.__index = LifestyleEntity


function LifestyleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LifestyleEntity)
  self._name = "lifestyle"
  self._client = client
...
function LifestyleEntity:get_name()
  return self._name
end


function LifestyleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LifestyleEntity.new(self._client, opts)
end
...
function LifestyleEntity:mark_deleted()
  self._deleted = true
end


function LifestyleEntity:deleted()
  return true == self._deleted
end


function LifestyleEntity:data_set(args)
  if args ~= nil then
...
function LifestyleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LifestyleEntity:match_set(args)
  if args ~= nil then
...
function LifestyleEntity:match_get()
...
function LifestyleEntity:stream(action, args, callopts)
...
---@param reqmatch LifestyleLoadMatch
---@param ctrl? table
---@return Lifestyle
---@return string? err
function LifestyleEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function LifestyleEntity:_run_op(ctx, post_done)
  local utility = self._utility
