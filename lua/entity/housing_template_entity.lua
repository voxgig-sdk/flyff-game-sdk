...
local HousingTemplateEntity = {}
HousingTemplateEntity.__index = HousingTemplateEntity


function HousingTemplateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, HousingTemplateEntity)
  self._name = "housing_template"
  self._client = client
...
function HousingTemplateEntity:get_name()
  return self._name
end


function HousingTemplateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return HousingTemplateEntity.new(self._client, opts)
end
...
function HousingTemplateEntity:mark_deleted()
  self._deleted = true
end


function HousingTemplateEntity:deleted()
  return true == self._deleted
end


function HousingTemplateEntity:data_set(args)
  if args ~= nil then
...
function HousingTemplateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function HousingTemplateEntity:match_set(args)
  if args ~= nil then
...
function HousingTemplateEntity:match_get()
...
function HousingTemplateEntity:stream(action, args, callopts)
...
---@param reqmatch HousingTemplateLoadMatch
---@param ctrl? table
---@return HousingTemplate
---@return string? err
function HousingTemplateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch HousingTemplateListMatch
---@param ctrl? table
---@return HousingTemplate[]
---@return string? err
function HousingTemplateEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function HousingTemplateEntity:_run_op(ctx, post_done)
  local utility = self._utility
