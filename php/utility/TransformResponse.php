...
// FlyffGame SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FlyffGameTransformResponse
{
    public static function call(FlyffGameContext $ctx): mixed
    {
        ...
        $transform = FlyffGameHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
