...
// FlyffGame SDK utility: fetcher

class FlyffGameFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FlyffGameSDK/1.0)';
    ...
    public static function call(FlyffGameContext $ctx, string $fullurl, array $fetchdef): array
    {
