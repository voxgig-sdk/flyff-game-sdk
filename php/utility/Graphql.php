...
class FlyffGameGraphql
{
    ...
    // equivalent.
    public static function body(FlyffGameContext $ctx): mixed
    {
    ...
    public static function errors(FlyffGameContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
