...
// FlyffGame SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FlyffGameSDK::test)
...
{
    private const SDK_CLASS = 'FlyffGameSDK';
    ...
    private const SDK_BASE = 'flyffgame_sdk';
