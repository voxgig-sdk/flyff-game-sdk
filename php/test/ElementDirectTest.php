...
class ElementDirectTest extends TestCase
{
    public function test_direct_load_element(): void
    {
        $setup = element_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-element", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
