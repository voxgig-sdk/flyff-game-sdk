...
class BadgeDirectTest extends TestCase
{
    public function test_direct_load_badge(): void
    {
        $setup = badge_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-badge", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
