...
class QuestEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FLYFFGAME_TEST_QUEST_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        [$quest_ref01_list_result, $err] = $quest_ref01_ent->list($quest_ref01_match, null);
        $this->assertNull($err);
...
function quest_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FLYFFGAME_TEST_QUEST_ENTID");
