...
// FlyffGame SDK UpgradeLevelBonus entity
...
class UpgradeLevelBonusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "upgrade_level_bonus";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UpgradeLevelBonusEntity($this->_client, $opts);
    }

    /**
     * @param UpgradeLevelBonus|array $args UpgradeLevelBonus data (assoc-array) to store.
     */
    ...
    /**
     * @return UpgradeLevelBonus|array The current UpgradeLevelBonus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UpgradeLevelBonus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UpgradeLevelBonus fields).
     */
    ...
    /**
     * Load a single UpgradeLevelBonus.
     *
     * @param UpgradeLevelBonusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UpgradeLevelBonusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UpgradeLevelBonus|array The loaded UpgradeLevelBonus as an assoc-array at the
