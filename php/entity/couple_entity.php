...
class CoupleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CoupleEntity($this->_client, $opts);
    }

    /**
     * @param Couple|array $args Couple data (assoc-array) to store.
     */
    ...
    /**
     * @return Couple|array The current Couple data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Couple fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Couple fields).
     */
     ...
     *
     * @param CoupleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CoupleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Couple|array The loaded Couple as an assoc-array at the
