...
// FlyffGame SDK EquipmentSet entity
...
class EquipmentSetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EquipmentSetEntity($this->_client, $opts);
    }

    /**
     * @param EquipmentSet|array $args EquipmentSet data (assoc-array) to store.
     */
    ...
    /**
     * @return EquipmentSet|array The current EquipmentSet data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EquipmentSet fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EquipmentSet fields).
     */
    ...
    /**
     * Load a single EquipmentSet.
     *
     * @param EquipmentSetLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EquipmentSetLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EquipmentSet|array The loaded EquipmentSet as an assoc-array at the
    ...
    /**
     * List EquipmentSet items matching the given filter.
     *
     * @param EquipmentSetListMatch|array|null $reqmatch Match filter (any subset
     *   of EquipmentSet fields) as an assoc-array; EquipmentSetListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EquipmentSet[]|array A list of EquipmentSet items as assoc-arrays at
