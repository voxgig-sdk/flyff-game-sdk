...
class AwakeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AwakeEntity($this->_client, $opts);
    }

    /**
     * @param Awake|array $args Awake data (assoc-array) to store.
     */
    ...
    /**
     * @return Awake|array The current Awake data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Awake fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Awake fields).
     */
     ...
     * Load a single Awake.
     *
     * @param AwakeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AwakeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Awake|array The loaded Awake as an assoc-array at the
