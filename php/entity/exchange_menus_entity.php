...
class ExchangeMenusEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ExchangeMenusEntity($this->_client, $opts);
    }

    /**
     * @param ExchangeMenus|array $args ExchangeMenus data (assoc-array) to store.
     */
    ...
    /**
     * @return ExchangeMenus|array The current ExchangeMenus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ExchangeMenus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ExchangeMenus fields).
     */
     ...
     *
     * @param ExchangeMenusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ExchangeMenusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ExchangeMenus|array The loaded ExchangeMenus as an assoc-array at the
