...
class DungeonEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DungeonEntity($this->_client, $opts);
    }

    /**
     * @param Dungeon|array $args Dungeon data (assoc-array) to store.
     */
    ...
    /**
     * @return Dungeon|array The current Dungeon data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Dungeon fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Dungeon fields).
     */
    ...
    /**
     * Load a single Dungeon.
     *
     * @param DungeonLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DungeonLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dungeon|array The loaded Dungeon as an assoc-array at the
