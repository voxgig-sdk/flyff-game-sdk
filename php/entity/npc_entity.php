...
class NpcEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NpcEntity($this->_client, $opts);
    }

    /**
     * @param Npc|array $args Npc data (assoc-array) to store.
     */
    ...
    /**
     * @return Npc|array The current Npc data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Npc fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Npc fields).
     */
     ...
     * Load a single Npc.
     *
     * @param NpcLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NpcLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Npc|array The loaded Npc as an assoc-array at the
    ...
    /**
     * List Npc items matching the given filter.
     *
     * @param NpcListMatch|array|null $reqmatch Match filter (any subset
     *   of Npc fields) as an assoc-array; NpcListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Npc[]|array A list of Npc items as assoc-arrays at
