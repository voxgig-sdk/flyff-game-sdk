...
class LanguageEntity
{
     ...
     *
     * @param LanguageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LanguageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Language|array The loaded Language as an assoc-array at the
