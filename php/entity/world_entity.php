...
class WorldEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WorldEntity($this->_client, $opts);
    }

    /**
     * @param World|array $args World data (assoc-array) to store.
     */
    ...
    /**
     * @return World|array The current World data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of World fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of World fields).
     */
     ...
     * Load a single World.
     *
     * @param WorldLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WorldLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return World|array The loaded World as an assoc-array at the
     ...
     *
     * @param WorldListMatch|array|null $reqmatch Match filter (any subset
     *   of World fields) as an assoc-array; WorldListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return World[]|array A list of World items as assoc-arrays at
