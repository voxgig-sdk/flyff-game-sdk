...
// FlyffGame SDK RaisedPet entity
...
class RaisedPetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RaisedPetEntity($this->_client, $opts);
    }

    /**
     * @param RaisedPet|array $args RaisedPet data (assoc-array) to store.
     */
    ...
    /**
     * @return RaisedPet|array The current RaisedPet data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RaisedPet fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RaisedPet fields).
     */
    ...
    /**
     * Load a single RaisedPet.
     *
     * @param RaisedPetLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RaisedPetLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RaisedPet|array The loaded RaisedPet as an assoc-array at the
