...
// FlyffGame SDK Lifestyle entity
...
class LifestyleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LifestyleEntity($this->_client, $opts);
    }

    /**
     * @param Lifestyle|array $args Lifestyle data (assoc-array) to store.
     */
    ...
    /**
     * @return Lifestyle|array The current Lifestyle data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Lifestyle fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Lifestyle fields).
     */
     ...
     *
     * @param LifestyleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LifestyleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Lifestyle|array The loaded Lifestyle as an assoc-array at the
