...
class PknEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PknEntity($this->_client, $opts);
    }

    /**
     * @param Pkn|array $args Pkn data (assoc-array) to store.
     */
    ...
    /**
     * @return Pkn|array The current Pkn data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Pkn fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Pkn fields).
     */
     ...
     * Load a single Pkn.
     *
     * @param PknLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PknLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pkn|array The loaded Pkn as an assoc-array at the
