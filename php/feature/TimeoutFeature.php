...
class FlyffGameTimeoutFeature extends FlyffGameBaseFeature
{
    ...
    private function _with_timeout(FlyffGameContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FlyffGameContext $_ctx, float $ms): void
    {
        $client = $this->client;
