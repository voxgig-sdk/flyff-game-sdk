...
// FlyffGame SDK clienttrack feature
...
class FlyffGameClienttrackFeature extends FlyffGameBaseFeature
{
    ...
    public function PostConstruct(FlyffGameContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FlyffGame-SDK';
