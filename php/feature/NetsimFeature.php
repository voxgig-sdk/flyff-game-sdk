...
class FlyffGameNetsimFeature extends FlyffGameBaseFeature
{
    ...
    private function _simulate(FlyffGameContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FlyffGameContext $ctx, array $applied): void
    {
        $client = $this->client;
