...
class NpcEntity
  ...
  # @return [Npc, Hash] the current Npc data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Npc fields)
  def match_get
  ...
  # Load a single Npc.
  #
  # @param reqmatch [NpcLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Npc.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Npc, Hash] the loaded Npc; raises FlyffGameError on failure
  ...
  #
  # @param reqmatch [NpcListMatch, Hash, nil] match filter (any subset of
  #   Npc fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Npc>, Array] the matching Npc items; raises FlyffGameError on failure
