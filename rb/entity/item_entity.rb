...
class ItemEntity
  ...
  # @return [Item, Hash] the loaded Item; raises FlyffGameError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Item>, Array] the matching Item items; raises FlyffGameError on failure
