# FlyffGame SDK Achievement entity
...
class AchievementEntity
  ...
  # @return [Achievement, Hash] the loaded Achievement; raises FlyffGameError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Achievement>, Array] the matching Achievement items; raises FlyffGameError on failure
