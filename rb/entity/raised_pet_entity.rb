...
class RaisedPetEntity
  ...
  def make
    opts = @_entopts.dup
    RaisedPetEntity.new(@_client, opts)
  end
  ...
  # @return [RaisedPet, Hash] the current RaisedPet data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RaisedPet fields)
  def match_get
  ...
  #
  # @param reqmatch [RaisedPetLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RaisedPet.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RaisedPet, Hash] the loaded RaisedPet; raises FlyffGameError on failure
