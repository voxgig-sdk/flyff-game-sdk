...
class ExchangeMenusEntity
  ...
  def make
    opts = @_entopts.dup
    ExchangeMenusEntity.new(@_client, opts)
  end
  ...
  # @return [ExchangeMenus, Hash] the current ExchangeMenus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ExchangeMenus fields)
  def match_get
