...
class RecipeEntity
  ...
  #
  # @param reqmatch [RecipeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Recipe.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Recipe, Hash] the loaded Recipe; raises FlyffGameError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Recipe>, Array] the matching Recipe items; raises FlyffGameError on failure
