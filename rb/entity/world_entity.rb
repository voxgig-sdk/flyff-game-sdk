...
class WorldEntity
  ...
  #   as an empty match, so client.World.load works with no args).
  ...
  #
  # @param reqmatch [WorldListMatch, Hash, nil] match filter (any subset of
  #   World fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
