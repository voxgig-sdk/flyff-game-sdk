...
class QuestEntity
  ...
  # @return [Quest, Hash] the current Quest data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Quest fields)
  def match_get
  ...
  # Load a single Quest.
  #
  # @param reqmatch [QuestLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Quest.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Quest, Hash] the loaded Quest; raises FlyffGameError on failure
  ...
  #
  # @param reqmatch [QuestListMatch, Hash, nil] match filter (any subset of
  #   Quest fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Quest>, Array] the matching Quest items; raises FlyffGameError on failure
