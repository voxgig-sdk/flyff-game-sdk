...
class EquipmentSetEntity
  ...
  def make
    opts = @_entopts.dup
    EquipmentSetEntity.new(@_client, opts)
  end
  ...
  # @return [EquipmentSet, Hash] the current EquipmentSet data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EquipmentSet fields)
  def match_get
  ...
  #
  # @param reqmatch [EquipmentSetLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.EquipmentSet.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [EquipmentSet, Hash] the loaded EquipmentSet; raises FlyffGameError on failure
  ...
  #
  # @param reqmatch [EquipmentSetListMatch, Hash, nil] match filter (any subset of
  #   EquipmentSet fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<EquipmentSet>, Array] the matching EquipmentSet items; raises FlyffGameError on failure
