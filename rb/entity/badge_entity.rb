...
class BadgeEntity
  ...
  # Load a single Badge.
  #
  # @param reqmatch [BadgeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Badge.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Badge, Hash] the loaded Badge; raises FlyffGameError on failure
