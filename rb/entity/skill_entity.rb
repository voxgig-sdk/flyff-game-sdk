...
class SkillEntity
  ...
  # @return [Skill, Hash] the loaded Skill; raises FlyffGameError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Skill>, Array] the matching Skill items; raises FlyffGameError on failure
