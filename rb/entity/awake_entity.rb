...
class AwakeEntity
  ...
  # @return [Awake, Hash] the current Awake data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Awake fields)
  def match_get
  ...
  # Load a single Awake.
  #
  # @param reqmatch [AwakeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Awake.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Awake, Hash] the loaded Awake; raises FlyffGameError on failure
