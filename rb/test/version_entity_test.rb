...
class VersionEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FLYFF_GAME_TEST_VERSION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def version_basic_setup(extra)
  ...
  entid_env_raw = ENV["FLYFF_GAME_TEST_VERSION_ENTID"]
