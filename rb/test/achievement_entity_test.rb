...
class AchievementEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FLYFFGAME_TEST_ACHIEVEMENT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def achievement_basic_setup(extra)
  ...
  entid_env_raw = ENV["FLYFFGAME_TEST_ACHIEVEMENT_ENTID"]
