# FlyffGame SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FlyffGameSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FlyffGameSDK(...) and FlyffGameSDK.test(...) become
#      FlyffGameSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "flyffgame_sdk"
_SDK_CLASS = "FlyffGameSDK"
...
_ENTITIES = {
    ...
    "ExchangeMenus": "exchange_menus",
    "HousingPack": "housing_pack",
    "HousingTemplate": "housing_template",
    "Item": "item",
    "Language": "language",
    "Lifestyle": "lifestyle",
    "Monster": "monster",
    "Npc": "npc",
    "PartySkill": "party_skill",
    "Pkn": "pkn",
    "Place": "place",
    "Quest": "quest",
    "RaisedPet": "raised_pet",
    "Recipe": "recipe",
    "Skill": "skill",
    "UpgradeLevelBonus": "upgrade_level_bonus",
    "Version": "version",
    "World": "world",
}
