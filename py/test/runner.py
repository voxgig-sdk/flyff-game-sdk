...
class FlyffGameTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FlyffGameTestRunner.getenv("FLYFFGAME_TEST_LIVE")
        override = FlyffGameTestRunner.getenv("FLYFFGAME_TEST_OVERRIDE")
        ...
        explain = FlyffGameTestRunner.getenv("FLYFFGAME_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["FLYFFGAME_TEST_EXPLAIN"] = explain
