...
class ExchangeMenusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ExchangeMenusEntity(self._client, opts)
    ...
    def data_get(self) -> ExchangeMenus:
    ...
    def match_get(self) -> ExchangeMenus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ExchangeMenus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ExchangeMenus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
