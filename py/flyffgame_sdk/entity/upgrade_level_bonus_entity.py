...
class UpgradeLevelBonusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UpgradeLevelBonusEntity(self._client, opts)
    ...
    def data_get(self) -> UpgradeLevelBonus:
    ...
    def match_get(self) -> UpgradeLevelBonus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> UpgradeLevelBonus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.UpgradeLevelBonus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
