...
class HousingTemplateEntity:
    ...
    def load(self, reqmatch: HousingTemplateLoadMatch, ctrl=None) -> HousingTemplate:
    ...
    def list(self, reqmatch: HousingTemplateListMatch, ctrl=None) -> list[HousingTemplate]:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "list",
            "ctrl": ctrl,
