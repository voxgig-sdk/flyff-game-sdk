...
**Entities** (27): `Achievement`, `Awake`, `Badge`, `Class`, `Core`, `Couple`, `Dungeon`, `Element`, `EquipmentSet`, `ExchangeMenus`, `HousingPack`, `HousingTemplate`, `Item`, `Language`, `Lifestyle`, `Monster`, `Npc`, `PartySkill`, `Pkn`, `Place`, `Quest`, `RaisedPet`, `Recipe`, `Skill`, `UpgradeLevelBonus`, `Version`, `World`.
