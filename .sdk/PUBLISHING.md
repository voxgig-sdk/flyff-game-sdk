...
|---|---|---|
| `ts/` | @voxgig-sdk/flyff-game-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/flyff-game-sdk \
      --repository voxgig-sdk/flyff-game-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/flyff-game-sdk` shows it, and
`npm trust revoke @voxgig-sdk/flyff-game-sdk --id=<id>` removes it.
