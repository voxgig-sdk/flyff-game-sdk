...
// FlyffGame SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FlyffGameOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FlyffGameOmni::structfix($now, Struct::undef()))
                        !== json_encode(FlyffGameOmni::structfix($val, Struct::undef()))) {
