...
class FlyffGameProxyFeature extends FlyffGameBaseFeature
{
    ...
    public function init(FlyffGameContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FlyffGameContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
