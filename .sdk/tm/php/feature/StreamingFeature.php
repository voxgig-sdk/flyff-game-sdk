...
// FlyffGame SDK streaming feature
...
class FlyffGameStreamingFeature extends FlyffGameBaseFeature
{
    ...
    private function _iterate(FlyffGameResult $result): \Generator
    {
    ...
    private function _streamable(FlyffGameContext $ctx): bool
    {
