...
// FlyffGame SDK ratelimit feature
...
class FlyffGameRatelimitFeature extends FlyffGameBaseFeature
{
    ...
    private function _acquire(FlyffGameContext $ctx): void
    {
    ...
    private function _track(FlyffGameContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
