...
// FlyffGame SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FlyffGameTestFeature extends FlyffGameBaseFeature
{
    ...
    public function init(FlyffGameContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FlyffGameContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FlyffGameParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FlyffGameContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FlyffGameContext $ctx, $op, $args): array
    {
