...
class FlyffGameCacheFeature extends FlyffGameBaseFeature
{
    ...
    private function _through(FlyffGameContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
