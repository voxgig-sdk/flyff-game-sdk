...
class FlyffGameRbacFeature extends FlyffGameBaseFeature
{
    ...
    private function _required(FlyffGameContext $ctx): ?string
    {
    ...
    private function _reject(FlyffGameContext $ctx, string $required): void
    {
    ...
    private function _track(FlyffGameContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
