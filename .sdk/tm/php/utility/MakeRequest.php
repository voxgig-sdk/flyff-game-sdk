...
// FlyffGame SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FlyffGameMakeRequest
{
    public static function call(FlyffGameContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FlyffGameResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FlyffGameResponse($fetched);
        } else {
