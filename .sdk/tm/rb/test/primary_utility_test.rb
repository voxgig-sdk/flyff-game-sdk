...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = FlyffGameOmni.make_runner(TEST_JSON_FILE, FlyffGameSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : FlyffGameOmni.errify(err)
    end
