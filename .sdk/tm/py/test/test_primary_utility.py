...
from projectname_sdk import FlyffGameSDK
from projectname_sdk.core.spec import FlyffGameSpec
from projectname_sdk.core.result import FlyffGameResult
from projectname_sdk.core.response import FlyffGameResponse
from projectname_sdk.core.operation import FlyffGameOperation
from projectname_sdk.core.error import FlyffGameError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import FlyffGameBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return FlyffGameError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = FlyffGameSDK.test(None, None)
        ...
        class TestInitFeature(FlyffGameBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FlyffGameBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FlyffGameSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FlyffGameSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FlyffGameSDK.test(None, setup_opts)
