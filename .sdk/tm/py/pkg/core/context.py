...
from projectname_sdk.core.control import FlyffGameControl
...
class FlyffGameContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FlyffGameSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FlyffGameResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FlyffGameResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FlyffGameError(code, msg, self)
