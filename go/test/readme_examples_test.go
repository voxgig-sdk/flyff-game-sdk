...
const testSeed = `map[string]any{"entity": map[string]any{"achievement": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "awake": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "badge": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "class": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "core": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "couple": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dungeon": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "element": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "equipment_set": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "exchange_menus": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "housing_pack": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "housing_template": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "language": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "lifestyle": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "monster": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "npc": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "party_skill": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pkn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "place": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "quest": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "raised_pet": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "recipe": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "skill": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "upgrade_level_bonus": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "version": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "world": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
