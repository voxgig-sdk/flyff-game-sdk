...
func NewRaisedPetEntity(client *core.FlyffGameSDK, entopts map[string]any) *RaisedPetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RaisedPetEntity) GetName() string { return e.name }
...
func (e *RaisedPetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RaisedPetEntity) Deleted() bool {
	return e.deleted
}


func (e *RaisedPetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRaisedPetEntity(e.client, opts)
}

func (e *RaisedPetEntity) Data(args ...any) any {
...
func (e *RaisedPetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RaisedPet; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RaisedPetEntity) DataTyped(data ...RaisedPet) RaisedPet {
	if len(data) > 0 {
		return typedFrom[RaisedPet](e.Data(asMap(data[0])))
	}
	return typedFrom[RaisedPet](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RaisedPet (all fields
// optional at the wire level).
func (e *RaisedPetEntity) MatchTyped(match ...RaisedPet) RaisedPet {
	if len(match) > 0 {
		return typedFrom[RaisedPet](e.Match(asMap(match[0])))
	}
	return typedFrom[RaisedPet](e.Match())
}
...
func (e *RaisedPetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RaisedPetEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RaisedPetLoadMatch and returns an RaisedPet. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RaisedPetEntity) LoadTyped(reqmatch RaisedPetLoadMatch, ctrl map[string]any) (RaisedPet, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RaisedPet{}, err
	}
	return typedFrom[RaisedPet](res), nil
}



func (e *RaisedPetEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RaisedPetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RaisedPetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RaisedPetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RaisedPetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
