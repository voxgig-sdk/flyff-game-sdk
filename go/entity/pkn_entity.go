...
func NewPknEntity(client *core.FlyffGameSDK, entopts map[string]any) *PknEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PknEntity) GetName() string { return e.name }
...
func (e *PknEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PknEntity) Deleted() bool {
	return e.deleted
}


func (e *PknEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPknEntity(e.client, opts)
}

func (e *PknEntity) Data(args ...any) any {
...
func (e *PknEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Pkn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PknEntity) DataTyped(data ...Pkn) Pkn {
	if len(data) > 0 {
		return typedFrom[Pkn](e.Data(asMap(data[0])))
	}
	return typedFrom[Pkn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Pkn (all fields
// optional at the wire level).
func (e *PknEntity) MatchTyped(match ...Pkn) Pkn {
	if len(match) > 0 {
		return typedFrom[Pkn](e.Match(asMap(match[0])))
	}
	return typedFrom[Pkn](e.Match())
}
...
func (e *PknEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PknEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PknLoadMatch and returns an Pkn. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PknEntity) LoadTyped(reqmatch PknLoadMatch, ctrl map[string]any) (Pkn, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Pkn{}, err
	}
	return typedFrom[Pkn](res), nil
}



func (e *PknEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PknEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PknEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PknEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PknEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
