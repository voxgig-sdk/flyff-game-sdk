...
func NewNpcEntity(client *core.FlyffGameSDK, entopts map[string]any) *NpcEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NpcEntity) GetName() string { return e.name }
...
func (e *NpcEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NpcEntity) Deleted() bool {
	return e.deleted
}


func (e *NpcEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNpcEntity(e.client, opts)
}

func (e *NpcEntity) Data(args ...any) any {
...
func (e *NpcEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Npc; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NpcEntity) DataTyped(data ...Npc) Npc {
	if len(data) > 0 {
		return typedFrom[Npc](e.Data(asMap(data[0])))
	}
	return typedFrom[Npc](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Npc (all fields
// optional at the wire level).
func (e *NpcEntity) MatchTyped(match ...Npc) Npc {
	if len(match) > 0 {
		return typedFrom[Npc](e.Match(asMap(match[0])))
	}
	return typedFrom[Npc](e.Match())
}
...
func (e *NpcEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NpcEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NpcLoadMatch and returns an Npc. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NpcEntity) LoadTyped(reqmatch NpcLoadMatch, ctrl map[string]any) (Npc, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Npc{}, err
	}
	return typedFrom[Npc](res), nil
}




func (e *NpcEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// NpcListMatch and returns []Npc. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *NpcEntity) ListTyped(reqmatch NpcListMatch, ctrl map[string]any) ([]Npc, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Npc](res), nil
}



func (e *NpcEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NpcEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NpcEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NpcEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
