...
type ExchangeMenusEntity struct {
	name    string
...
func NewExchangeMenusEntity(client *core.FlyffGameSDK, entopts map[string]any) *ExchangeMenusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ExchangeMenusEntity) GetName() string { return e.name }
...
func (e *ExchangeMenusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ExchangeMenusEntity) Deleted() bool {
	return e.deleted
}


func (e *ExchangeMenusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewExchangeMenusEntity(e.client, opts)
}

func (e *ExchangeMenusEntity) Data(args ...any) any {
...
func (e *ExchangeMenusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ExchangeMenus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ExchangeMenusEntity) DataTyped(data ...ExchangeMenus) ExchangeMenus {
	if len(data) > 0 {
		return typedFrom[ExchangeMenus](e.Data(asMap(data[0])))
	}
	return typedFrom[ExchangeMenus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ExchangeMenus (all fields
// optional at the wire level).
func (e *ExchangeMenusEntity) MatchTyped(match ...ExchangeMenus) ExchangeMenus {
	if len(match) > 0 {
		return typedFrom[ExchangeMenus](e.Match(asMap(match[0])))
	}
	return typedFrom[ExchangeMenus](e.Match())
}
...
func (e *ExchangeMenusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ExchangeMenusEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ExchangeMenusLoadMatch and returns an ExchangeMenus. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ExchangeMenusEntity) LoadTyped(reqmatch ExchangeMenusLoadMatch, ctrl map[string]any) (ExchangeMenus, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ExchangeMenus{}, err
	}
	return typedFrom[ExchangeMenus](res), nil
}



func (e *ExchangeMenusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ExchangeMenusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ExchangeMenusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ExchangeMenusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ExchangeMenusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
