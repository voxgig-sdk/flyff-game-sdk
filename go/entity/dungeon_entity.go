...
func NewDungeonEntity(client *core.FlyffGameSDK, entopts map[string]any) *DungeonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DungeonEntity) GetName() string { return e.name }
...
func (e *DungeonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DungeonEntity) Deleted() bool {
	return e.deleted
}


func (e *DungeonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDungeonEntity(e.client, opts)
}

func (e *DungeonEntity) Data(args ...any) any {
...
func (e *DungeonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Dungeon; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DungeonEntity) DataTyped(data ...Dungeon) Dungeon {
	if len(data) > 0 {
		return typedFrom[Dungeon](e.Data(asMap(data[0])))
	}
	return typedFrom[Dungeon](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Dungeon (all fields
// optional at the wire level).
func (e *DungeonEntity) MatchTyped(match ...Dungeon) Dungeon {
	if len(match) > 0 {
		return typedFrom[Dungeon](e.Match(asMap(match[0])))
	}
	return typedFrom[Dungeon](e.Match())
}
...
func (e *DungeonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DungeonEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DungeonLoadMatch and returns an Dungeon. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DungeonEntity) LoadTyped(reqmatch DungeonLoadMatch, ctrl map[string]any) (Dungeon, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Dungeon{}, err
	}
	return typedFrom[Dungeon](res), nil
}



func (e *DungeonEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DungeonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DungeonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DungeonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DungeonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
