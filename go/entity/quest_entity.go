...
func NewQuestEntity(client *core.FlyffGameSDK, entopts map[string]any) *QuestEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *QuestEntity) GetName() string { return e.name }
...
func (e *QuestEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *QuestEntity) Deleted() bool {
	return e.deleted
}


func (e *QuestEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewQuestEntity(e.client, opts)
}

func (e *QuestEntity) Data(args ...any) any {
...
func (e *QuestEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Quest; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *QuestEntity) DataTyped(data ...Quest) Quest {
	if len(data) > 0 {
		return typedFrom[Quest](e.Data(asMap(data[0])))
	}
	return typedFrom[Quest](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Quest (all fields
// optional at the wire level).
func (e *QuestEntity) MatchTyped(match ...Quest) Quest {
	if len(match) > 0 {
		return typedFrom[Quest](e.Match(asMap(match[0])))
	}
	return typedFrom[Quest](e.Match())
}
...
func (e *QuestEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *QuestEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// QuestLoadMatch and returns an Quest. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *QuestEntity) LoadTyped(reqmatch QuestLoadMatch, ctrl map[string]any) (Quest, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Quest{}, err
	}
	return typedFrom[Quest](res), nil
}




func (e *QuestEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// QuestListMatch and returns []Quest. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *QuestEntity) ListTyped(reqmatch QuestListMatch, ctrl map[string]any) ([]Quest, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Quest](res), nil
}



func (e *QuestEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *QuestEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *QuestEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *QuestEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
