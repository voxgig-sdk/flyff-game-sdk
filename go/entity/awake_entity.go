...
func NewAwakeEntity(client *core.FlyffGameSDK, entopts map[string]any) *AwakeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AwakeEntity) GetName() string { return e.name }
...
func (e *AwakeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AwakeEntity) Deleted() bool {
	return e.deleted
}


func (e *AwakeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAwakeEntity(e.client, opts)
}

func (e *AwakeEntity) Data(args ...any) any {
...
func (e *AwakeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Awake; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AwakeEntity) DataTyped(data ...Awake) Awake {
	if len(data) > 0 {
		return typedFrom[Awake](e.Data(asMap(data[0])))
	}
	return typedFrom[Awake](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Awake (all fields
// optional at the wire level).
func (e *AwakeEntity) MatchTyped(match ...Awake) Awake {
	if len(match) > 0 {
		return typedFrom[Awake](e.Match(asMap(match[0])))
	}
	return typedFrom[Awake](e.Match())
}
...
func (e *AwakeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AwakeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AwakeLoadMatch and returns an Awake. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AwakeEntity) LoadTyped(reqmatch AwakeLoadMatch, ctrl map[string]any) (Awake, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Awake{}, err
	}
	return typedFrom[Awake](res), nil
}



func (e *AwakeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AwakeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AwakeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AwakeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AwakeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
