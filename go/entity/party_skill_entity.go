...
func NewPartySkillEntity(client *core.FlyffGameSDK, entopts map[string]any) *PartySkillEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PartySkillEntity) GetName() string { return e.name }
...
func (e *PartySkillEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PartySkillEntity) Deleted() bool {
	return e.deleted
}


func (e *PartySkillEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPartySkillEntity(e.client, opts)
}

func (e *PartySkillEntity) Data(args ...any) any {
...
func (e *PartySkillEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PartySkill; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PartySkillEntity) DataTyped(data ...PartySkill) PartySkill {
	if len(data) > 0 {
		return typedFrom[PartySkill](e.Data(asMap(data[0])))
	}
	return typedFrom[PartySkill](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PartySkill (all fields
// optional at the wire level).
func (e *PartySkillEntity) MatchTyped(match ...PartySkill) PartySkill {
	if len(match) > 0 {
		return typedFrom[PartySkill](e.Match(asMap(match[0])))
	}
	return typedFrom[PartySkill](e.Match())
}
...
func (e *PartySkillEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PartySkillEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PartySkillLoadMatch and returns an PartySkill. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PartySkillEntity) LoadTyped(reqmatch PartySkillLoadMatch, ctrl map[string]any) (PartySkill, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PartySkill{}, err
	}
	return typedFrom[PartySkill](res), nil
}




func (e *PartySkillEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PartySkillListMatch and returns []PartySkill. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PartySkillEntity) ListTyped(reqmatch PartySkillListMatch, ctrl map[string]any) ([]PartySkill, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PartySkill](res), nil
}



func (e *PartySkillEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PartySkillEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PartySkillEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PartySkillEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
