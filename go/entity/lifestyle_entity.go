...
func NewLifestyleEntity(client *core.FlyffGameSDK, entopts map[string]any) *LifestyleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LifestyleEntity) GetName() string { return e.name }
...
func (e *LifestyleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LifestyleEntity) Deleted() bool {
	return e.deleted
}


func (e *LifestyleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLifestyleEntity(e.client, opts)
}

func (e *LifestyleEntity) Data(args ...any) any {
...
func (e *LifestyleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Lifestyle; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LifestyleEntity) DataTyped(data ...Lifestyle) Lifestyle {
	if len(data) > 0 {
		return typedFrom[Lifestyle](e.Data(asMap(data[0])))
	}
	return typedFrom[Lifestyle](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Lifestyle (all fields
// optional at the wire level).
func (e *LifestyleEntity) MatchTyped(match ...Lifestyle) Lifestyle {
	if len(match) > 0 {
		return typedFrom[Lifestyle](e.Match(asMap(match[0])))
	}
	return typedFrom[Lifestyle](e.Match())
}
...
func (e *LifestyleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LifestyleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LifestyleLoadMatch and returns an Lifestyle. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LifestyleEntity) LoadTyped(reqmatch LifestyleLoadMatch, ctrl map[string]any) (Lifestyle, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Lifestyle{}, err
	}
	return typedFrom[Lifestyle](res), nil
}



func (e *LifestyleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LifestyleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LifestyleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LifestyleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LifestyleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
