...
func NewHousingPackEntity(client *core.FlyffGameSDK, entopts map[string]any) *HousingPackEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HousingPackEntity) GetName() string { return e.name }
...
func (e *HousingPackEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HousingPackEntity) Deleted() bool {
	return e.deleted
}


func (e *HousingPackEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHousingPackEntity(e.client, opts)
}

func (e *HousingPackEntity) Data(args ...any) any {
...
func (e *HousingPackEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an HousingPack; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HousingPackEntity) DataTyped(data ...HousingPack) HousingPack {
	if len(data) > 0 {
		return typedFrom[HousingPack](e.Data(asMap(data[0])))
	}
	return typedFrom[HousingPack](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through HousingPack (all fields
// optional at the wire level).
func (e *HousingPackEntity) MatchTyped(match ...HousingPack) HousingPack {
	if len(match) > 0 {
		return typedFrom[HousingPack](e.Match(asMap(match[0])))
	}
	return typedFrom[HousingPack](e.Match())
}
...
func (e *HousingPackEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HousingPackEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HousingPackLoadMatch and returns an HousingPack. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HousingPackEntity) LoadTyped(reqmatch HousingPackLoadMatch, ctrl map[string]any) (HousingPack, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return HousingPack{}, err
	}
	return typedFrom[HousingPack](res), nil
}




func (e *HousingPackEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// HousingPackListMatch and returns []HousingPack. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *HousingPackEntity) ListTyped(reqmatch HousingPackListMatch, ctrl map[string]any) ([]HousingPack, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[HousingPack](res), nil
}



func (e *HousingPackEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HousingPackEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HousingPackEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HousingPackEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
