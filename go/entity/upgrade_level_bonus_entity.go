...
func (e *UpgradeLevelBonusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UpgradeLevelBonusEntity) Deleted() bool {
	return e.deleted
}
...
// argument it returns the current data as an UpgradeLevelBonus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UpgradeLevelBonusEntity) DataTyped(data ...UpgradeLevelBonus) UpgradeLevelBonus {
	if len(data) > 0 {
		return typedFrom[UpgradeLevelBonus](e.Data(asMap(data[0])))
	}
	return typedFrom[UpgradeLevelBonus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UpgradeLevelBonus (all fields
// optional at the wire level).
func (e *UpgradeLevelBonusEntity) MatchTyped(match ...UpgradeLevelBonus) UpgradeLevelBonus {
	if len(match) > 0 {
		return typedFrom[UpgradeLevelBonus](e.Match(asMap(match[0])))
	}
	return typedFrom[UpgradeLevelBonus](e.Match())
}
...
func (e *UpgradeLevelBonusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
// UpgradeLevelBonusLoadMatch and returns an UpgradeLevelBonus. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UpgradeLevelBonusEntity) LoadTyped(reqmatch UpgradeLevelBonusLoadMatch, ctrl map[string]any) (UpgradeLevelBonus, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UpgradeLevelBonus{}, err
	}
	return typedFrom[UpgradeLevelBonus](res), nil
}
