...
func NewCoupleEntity(client *core.FlyffGameSDK, entopts map[string]any) *CoupleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CoupleEntity) GetName() string { return e.name }
...
func (e *CoupleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CoupleEntity) Deleted() bool {
	return e.deleted
}


func (e *CoupleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCoupleEntity(e.client, opts)
}

func (e *CoupleEntity) Data(args ...any) any {
...
func (e *CoupleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Couple; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CoupleEntity) DataTyped(data ...Couple) Couple {
	if len(data) > 0 {
		return typedFrom[Couple](e.Data(asMap(data[0])))
	}
	return typedFrom[Couple](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Couple (all fields
// optional at the wire level).
func (e *CoupleEntity) MatchTyped(match ...Couple) Couple {
	if len(match) > 0 {
		return typedFrom[Couple](e.Match(asMap(match[0])))
	}
	return typedFrom[Couple](e.Match())
}
...
func (e *CoupleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CoupleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CoupleLoadMatch and returns an Couple. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CoupleEntity) LoadTyped(reqmatch CoupleLoadMatch, ctrl map[string]any) (Couple, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Couple{}, err
	}
	return typedFrom[Couple](res), nil
}



func (e *CoupleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CoupleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CoupleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CoupleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CoupleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
