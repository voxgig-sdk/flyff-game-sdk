...
func NewClassEntity(client *core.FlyffGameSDK, entopts map[string]any) *ClassEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ClassEntity) GetName() string { return e.name }
...
func (e *ClassEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ClassEntity) Deleted() bool {
	return e.deleted
}


func (e *ClassEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewClassEntity(e.client, opts)
}

func (e *ClassEntity) Data(args ...any) any {
...
func (e *ClassEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Class; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ClassEntity) DataTyped(data ...Class) Class {
	if len(data) > 0 {
		return typedFrom[Class](e.Data(asMap(data[0])))
	}
	return typedFrom[Class](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Class (all fields
// optional at the wire level).
func (e *ClassEntity) MatchTyped(match ...Class) Class {
	if len(match) > 0 {
		return typedFrom[Class](e.Match(asMap(match[0])))
	}
	return typedFrom[Class](e.Match())
}
...
func (e *ClassEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ClassEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ClassLoadMatch and returns an Class. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ClassEntity) LoadTyped(reqmatch ClassLoadMatch, ctrl map[string]any) (Class, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Class{}, err
	}
	return typedFrom[Class](res), nil
}




func (e *ClassEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ClassListMatch and returns []Class. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ClassEntity) ListTyped(reqmatch ClassListMatch, ctrl map[string]any) ([]Class, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Class](res), nil
}



func (e *ClassEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ClassEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ClassEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ClassEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
