...
type EquipmentSetEntity struct {
	name    string
...
func NewEquipmentSetEntity(client *core.FlyffGameSDK, entopts map[string]any) *EquipmentSetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EquipmentSetEntity) GetName() string { return e.name }
...
func (e *EquipmentSetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EquipmentSetEntity) Deleted() bool {
	return e.deleted
}


func (e *EquipmentSetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEquipmentSetEntity(e.client, opts)
}

func (e *EquipmentSetEntity) Data(args ...any) any {
...
func (e *EquipmentSetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EquipmentSet; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EquipmentSetEntity) DataTyped(data ...EquipmentSet) EquipmentSet {
	if len(data) > 0 {
		return typedFrom[EquipmentSet](e.Data(asMap(data[0])))
	}
	return typedFrom[EquipmentSet](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EquipmentSet (all fields
// optional at the wire level).
func (e *EquipmentSetEntity) MatchTyped(match ...EquipmentSet) EquipmentSet {
	if len(match) > 0 {
		return typedFrom[EquipmentSet](e.Match(asMap(match[0])))
	}
	return typedFrom[EquipmentSet](e.Match())
}
...
func (e *EquipmentSetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EquipmentSetEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EquipmentSetLoadMatch and returns an EquipmentSet. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EquipmentSetEntity) LoadTyped(reqmatch EquipmentSetLoadMatch, ctrl map[string]any) (EquipmentSet, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EquipmentSet{}, err
	}
	return typedFrom[EquipmentSet](res), nil
}




func (e *EquipmentSetEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// EquipmentSetListMatch and returns []EquipmentSet. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EquipmentSetEntity) ListTyped(reqmatch EquipmentSetListMatch, ctrl map[string]any) ([]EquipmentSet, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[EquipmentSet](res), nil
}



func (e *EquipmentSetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EquipmentSetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EquipmentSetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EquipmentSetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
