...
## Install
```bash
go get github.com/voxgig-sdk/flyff-game-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/flyff-game-sdk=../path/to/github.com/voxgig-sdk/flyff-game-sdk
```
...
```
github.com/voxgig-sdk/flyff-game-sdk/
...
The root package (`github.com/voxgig-sdk/flyff-game-sdk`) re-exports everything needed
