...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/flyff-game` | `npm install @voxgig-sdk/flyff-game` |
| Python | `voxgig-sdk-flyff-game` | `pip install voxgig-sdk-flyff-game` |
| PHP | `voxgig-sdk/flyff-game` | `composer require voxgig-sdk/flyff-game` |
| Golang | `github.com/voxgig-sdk/flyff-game-sdk/go` | `go get github.com/voxgig-sdk/flyff-game-sdk/go` |
| Ruby | `voxgig-sdk-flyff-game` | `gem install voxgig-sdk-flyff-game` |
| Lua | `voxgig-sdk-flyff-game` | `luarocks install voxgig-sdk-flyff-game` |
