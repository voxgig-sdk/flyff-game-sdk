...
The TypeScript SDK for the FlyffGame API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new FlyffGameSDK({ apikey: '...' })
