...
(0, node_test_1.describe)('CoupleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-couple', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-couple', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FLYFF_GAME_TEST_COUPLE_ENTID'];
...
//# sourceMappingURL=CoupleDirect.test.js.map