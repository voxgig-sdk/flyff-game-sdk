...
(0, node_test_1.describe)('AwakeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'awake.' + op, live))
                return;
        }
        ...
        let awake_ref01_data = Object.values(setup.data.existing.awake)[0];
        // LOAD
        const awake_ref01_ent = client.Awake();
        const awake_ref01_match_dt0 = {};
        const awake_ref01_data_dt0 = (await awake_ref01_ent.load(awake_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != awake_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/awake/AwakeTestData.json');
    ...
    let idmap = transform(['awake01', 'awake02', 'awake03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['FLYFF_GAME_TEST_AWAKE_ENTID'];
...
//# sourceMappingURL=AwakeEntity.test.js.map