...
(0, node_test_1.describe)('PartySkillEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'party_skill.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['party_skill01', 'party_skill02', 'party_skill03', 'partyskill01', 'partyskill02', 'partyskill03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['FLYFF_GAME_TEST_PARTY_SKILL_ENTID'];
