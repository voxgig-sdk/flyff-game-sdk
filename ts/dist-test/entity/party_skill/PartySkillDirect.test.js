...
(0, node_test_1.describe)('PartySkillDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-party_skill', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-party_skill', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["party_skill01"]))
            return;
        ...
        if (setup.live) {
            ...
            const candidateId = listArr[0]?.party_skill_id ?? listArr[0]?.id;
            if (null == candidateId) {
                throw new Error('Live load blocked: discovery returned no usable identity');
            }
            params.party_skill_id = candidateId;
    ...
    (0, node_test_1.test)('direct-list-party_skill', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-party_skill', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FLYFF_GAME_TEST_PARTY_SKILL_ENTID'];
...
//# sourceMappingURL=PartySkillDirect.test.js.map