...
(0, node_test_1.describe)('UpgradeLevelBonusEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'upgrade_level_bonus.' + op, live))
                return;
        }
        ...
        let upgrade_level_bonus_ref01_data = Object.values(setup.data.existing.upgrade_level_bonus)[0];
        // LOAD
        const upgrade_level_bonus_ref01_ent = client.UpgradeLevelBonus();
        const upgrade_level_bonus_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(null != upgrade_level_bonus_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/upgrade_level_bonus/UpgradeLevelBonusTestData.json');
    ...
    let idmap = transform(['upgrade_level_bonus01', 'upgrade_level_bonus02', 'upgrade_level_bonus03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['FLYFF_GAME_TEST_UPGRADE_LEVEL_BONUS_ENTID'];
...
//# sourceMappingURL=UpgradeLevelBonusEntity.test.js.map