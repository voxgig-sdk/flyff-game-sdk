...
(0, node_test_1.describe)('UpgradeLevelBonusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-upgrade_level_bonus', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-upgrade_level_bonus', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FLYFF_GAME_TEST_UPGRADE_LEVEL_BONUS_ENTID'];
...
//# sourceMappingURL=UpgradeLevelBonusDirect.test.js.map