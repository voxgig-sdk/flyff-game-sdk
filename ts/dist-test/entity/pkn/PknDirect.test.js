...
(0, node_test_1.describe)('PknDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-pkn', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-pkn', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FLYFF_GAME_TEST_PKN_ENTID'];
...
//# sourceMappingURL=PknDirect.test.js.map