...
(0, node_test_1.describe)('ExchangeMenusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-exchange_menus', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-exchange_menus', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'FLYFF_GAME_TEST_EXCHANGE_MENUS_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['FLYFF_GAME_TEST_EXCHANGE_MENUS_ENTID'];
...
//# sourceMappingURL=ExchangeMenusDirect.test.js.map