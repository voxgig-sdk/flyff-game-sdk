...
(0, node_test_1.describe)('RaisedPetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-raised_pet', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-raised_pet', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FLYFF_GAME_TEST_RAISED_PET_ENTID'];
...
//# sourceMappingURL=RaisedPetDirect.test.js.map