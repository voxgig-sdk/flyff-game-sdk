...
(0, node_test_1.describe)('RecipeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(recipe_ref01_data_dt0.id === recipe_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['FLYFF_GAME_TEST_RECIPE_ENTID'];
