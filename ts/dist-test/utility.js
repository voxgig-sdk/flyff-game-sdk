...
function envOverride(m) {
    if ('TRUE' === process.env.FLYFF_GAME_TEST_LIVE ||
        'TRUE' === process.env.FLYFF_GAME_TEST_OVERRIDE) {
    ...
    m.FLYFF_GAME_TEST_EXPLAIN = process.env.FLYFF_GAME_TEST_EXPLAIN || m.FLYFF_GAME_TEST_EXPLAIN;
    return m;
}
