...
//     (\`new FlyffGameSDK(...)\` / \`FlyffGameSDK.test(...)\` become
//     \`FlyffGameSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"achievement":{"test01":{"id":"test01"}},"awake":{"test01":{"id":"test01"}},"badge":{"test01":{"id":"test01"}},"class":{"test01":{"id":"test01"}},"core":{"test01":{"id":"test01"}},"couple":{"test01":{"id":"test01"}},"dungeon":{"test01":{"id":"test01"}},"element":{"test01":{"id":"test01"}},"equipment_set":{"test01":{"id":"test01"}},"exchange_menus":{"test01":{"id":"test01"}},"housing_pack":{"test01":{"id":"test01"}},"housing_template":{"test01":{"id":"test01"}},"item":{"test01":{"id":"test01"}},"language":{"test01":{"id":"test01"}},"lifestyle":{"test01":{"id":"test01"}},"monster":{"test01":{"id":"test01"}},"npc":{"test01":{"id":"test01"}},"party_skill":{"test01":{"id":"test01"}},"pkn":{"test01":{"id":"test01"}},"place":{"test01":{"id":"test01"}},"quest":{"test01":{"id":"test01"}},"raised_pet":{"test01":{"id":"test01"}},"recipe":{"test01":{"id":"test01"}},"skill":{"test01":{"id":"test01"}},"upgrade_level_bonus":{"test01":{"id":"test01"}},"version":{"test01":{"id":"test01"}},"world":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new FlyffGameSDK(...)\` and any
// \`FlyffGameSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+FlyffGameSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/FlyffGameSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
